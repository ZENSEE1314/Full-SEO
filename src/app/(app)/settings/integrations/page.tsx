...
const INTEGRATIONS = [
  {
    ...
    description:
      "Import search performance data, indexing status, and keyword rankings directly from GSC.",
    isConnected: false,
    lastSyncAt: null,
  },
  {
  ...
  },
  {
    ...
    name: "n8n Automation",
    description:
      "Connect your n8n instance to power AI workflows, data pipelines, and automated tasks.",
    isConnected: true,
  ...
  },
  {
    ...
    name: "SMTP Email",
    description:
      "Configure outgoing email for outreach sequences and team notifications.",
    isConnected: false,
    lastSyncAt: null,
  },
  {
    ...
    description:
      "Send outreach messages and notifications through WhatsApp Business API.",
    isConnected: false,
    lastSyncAt: null,
  },
] as const;
      ...
      <div className="mx-auto max-w-5xl space-y-8 px-4 py-8 sm:px-6 lg:px-8">
        ...
        <div className="flex items-center gap-4 animate-[fade-in_0.5s_ease-out_0.1s_both]">
          ...
          <div className="flex items-center gap-1.5 rounded-lg bg-slate-500/10 px-3 py-1.5 text-xs font-medium text-muted-foreground border border-white/[0.06]">
            ...
            {INTEGRATIONS.filter((i) => !i.isConnected).length} Available
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3">
          {INTEGRATIONS.map((integration, index) => (
            <IntegrationCard
              ...
              icon={<IntegrationIcon id={integration.id} />}
