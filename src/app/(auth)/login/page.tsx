    ...
    <div className="rounded-2xl border border-white/[0.06] bg-white/[0.02] p-8 shadow-[0_0_0_1px_rgba(255,255,255,0.02),0_20px_50px_-12px_rgba(0,0,0,0.5)] backdrop-blur-2xl sm:p-10">
      ...
      <div className="grid grid-cols-2 gap-3">
        <button
          type="button"
          disabled
          className="flex h-10 items-center justify-center gap-2 rounded-xl border border-white/[0.06] bg-white/[0.02] text-sm text-slate-500 transition-colors hover:bg-white/[0.04] disabled:cursor-not-allowed disabled:opacity-40"
